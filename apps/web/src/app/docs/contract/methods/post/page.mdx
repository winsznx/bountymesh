export const metadata = {
  title: "Bounty/Post",
  description: "Create a new bounty. Payable. Escrows the reward and refunds excess via CommandReply::with_value.",
};
...
<ParamTable>
  ...
  <Param name="deadline" type="Option<u32>">
    Optional block height. Advisory today — a future `AutoSettle` method will consume it.
  </Param>
