export const metadata = {
  title: "Build a worker daemon",
  description: "Reference architecture for the BountyMesh worker. 7-stage boot, 5-stage main FSM, crash-resume orchestrator, indexer health-gate.",
};
