export const metadata = {
  title: "IDL reference",
  description: "The full Sails IDL for the BountyMesh contract. Generated from Rust source via cargo sails; blessed snapshot used for SDK codegen drift checks.",
};
